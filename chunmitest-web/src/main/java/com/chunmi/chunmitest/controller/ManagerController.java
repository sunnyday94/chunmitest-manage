...
import com.chunmi.chunmitest.service.ManagerService;
import com.chunmi.chunmitest.util.Constants;
import com.chunmi.chunmitest.util.MD5Util;
...
public class ManagerController {
	...
	public RedirectView logout(HttpServletRequest request,HttpServletResponse response){
		...
		return new RedirectView(Constants.INITINDEX);
	}
	 ...
	 * @author: <a href="mailto:wangzhifang@chunmi.com ">wangzhifang</a>
	 * @date: 2017年7月6日-下午1:33:06
	 * @param @param pageBean
	 * @param @return
	 * @return ModelAndView
	 */
	@RequestMapping(value="manager/managerlist",method = RequestMethod.GET)
	 ...
	 * @author: <a href="mailto:wangzhifang@chunmi.com ">wangzhifang</a>
	 * @date: 2017年7月6日-下午5:36:01
	 * @param @param manager
	 * @param @return
	 * @return String
	 */
	@RequestMapping(value="manager/updateManagerStatus")
	@ResponseBody
