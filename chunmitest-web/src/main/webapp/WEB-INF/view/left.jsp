		...
		<ul class="sidebar-menu">
			<li id="dashboard" class="treeview">
				<a href="#"> <i	class="fa fa-dashboard"></i> 
					<span>配置</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span>
				</a>
				<ul class="treeview-menu">
					<li id="requestParamsConfig"><a href="<%=basePath%>setting/requestParamsConfig.do"><i class="fa fa-circle-o"></i>接口测试</a></li>
					<li id="settinglist"><a href="<%=basePath%>setting/settinglist.do"><i class="fa fa-circle-o"></i>列表</a></li>
				</ul>
			</li>
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li id="managerList"><a href="<%=basePath%>manager/managerlist.do"><i class="fa fa-circle-o"></i>管理员列表</a></li>
				</ul>
			</li>
		</ul>
	</section>
