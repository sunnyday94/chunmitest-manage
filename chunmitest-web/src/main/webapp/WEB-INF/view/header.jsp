...
<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><b>纯</b>米</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>纯米科技</b></span>
  </a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="register-box-body" style="padding:20px 40px;">
				<form action="updateManager.do" method="post" id="modifyManagerForm">
...
<div style="display:none">
	<form action="<%=basePath %>logout.do" method="post" id="logoutForm"></form>
</div>
